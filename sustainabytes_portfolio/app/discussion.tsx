...
function Tables() {
  return (
    <div id="tableDisplay" className="flex flex-col md:flex-row">
      <table className="items-center p-[10px] table-fixed w-[80vw]">
        <thead>
          <tr>
            <td rowSpan={2}></td>
    ...
    <section id="discussion" className="min-h-screen snap-start flex flex-col justify-center items-center relative">
      <div className="z-10 w-[70vw] text-center space-y-8">
        ...
        <div>
          ...
          <p className="p mt-6">More concerning is the error in predicting poverty incidence and number of poverty-stricken families, 
            ...
            tuned to these other factors as well. </p>
        </div>
      </div>
    </section>
  );
